        ...
        <div class="page-title">
            <div class="row">
                <div class="order-last col-12 col-md-6 order-md-1">
                    <h2>Sunting Lokasi Kerja</h2>
                    <p class="text-subtitle text-muted">
                        Lakukan penyuntingan terhadap suatu data master lokasi kerja.
                    </p>
                    <hr>
                    <div class="mb-4">
                        ...
                        <a data-bs-toggle="tooltip" data-bs-original-title="Hapus data master lokasi kerja." href="#"
                            class="px-2 pt-2 btn btn-danger" data-confirm-lokasi-kerja-destroy="true"
                            data-unique="{{ $lokasiKerja->id_lokasi_kerja }}">
                            <span data-confirm-lokasi-kerja-destroy="true" data-unique="{{ $lokasiKerja->id_lokasi_kerja }}"
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form"
                                    action="{{ $dashboardURL }}/master-lokasi-kerja/{{ $lokasiKerja->id_lokasi_kerja }}"
                                    method="POST">
                                    @method('PUT')
                                    @csrf
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input autofocus type="text" class="py-2 form-control"
                                                        ...
                                                        value="{{ old('nama_lokasi_kerja') ?? $lokasiKerja->nama_lokasi_kerja }}" />
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input autofocus type="text" class="py-2 form-control"
                                                        ...
                                                        name="nama_alias"
                                                        value="{{ old('nama_alias') ?? $lokasiKerja->nama_alias }}" />
                                                    <div class="form-control-icon">
                                                        <i class="py-2 bi bi-card-heading"></i>
                                                    </div>
                                                    @error('nama_alias')
