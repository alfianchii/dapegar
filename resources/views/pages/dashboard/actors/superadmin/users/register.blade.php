            ...
            <div class="row">
                <div class="order-last col-12 col-md-6 order-md-1">
                    ...
                    <p class="text-subtitle text-muted">
                        Daftarkan pengguna untuk melakukan sesuatu di {{ config('app.name') }}.
                    </p>
                    <hr>
                    <div class="mb-4">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ $dashboardURL }}/users" method="POST"
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="py-2 form-control"
                                                        ...
                                                        value="{{ old('telepon') }}" min="11" max="13"
                                                        maxlength="13" />
                                                    <div class="form-control-icon">
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" class="py-2 form-control"
                                                        ...
                                                        name="npwp" value="{{ old('npwp') }}" maxlength="25" />
                                                    <div class="form-control-icon">
                                                    ...
                                                    <select class="form-select" id="id_golongan_pangkat"
                                                        ...
                                                        @foreach ($golonganPangkat as $item)
                                                            <option value="{{ $item->id_golongan_pangkat }}"
                                                                @if (old('id_golongan_pangkat')) selected @endif>
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <select class="form-select" id="id_eselon" name="id_eselon">
                                                        @foreach ($eselon as $item)
                                                            <option value="{{ $item->id_eselon }}"
                                                                @if (old('id_eselon')) selected @endif>
                                                                {{ $item->nama_eselon }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select class="form-select" id="id_jabatan" name="id_jabatan">
                                                        @foreach ($jabatan as $item)
                                                            <option value="{{ $item->id_jabatan }}"
                                                                @if (old('id_jabatan')) selected @endif>
                                                                {{ $item->nama_jabatan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <select class="form-select" id="id_lokasi_kerja"
                                                        ...
                                                        @foreach ($lokasiKerja as $item)
                                                            <option value="{{ $item->id_lokasi_kerja }}"
                                                                @if (old('id_lokasi_kerja')) selected @endif>
                                                    ...
                                                    <select class="form-select" id="id_unit_kerja" name="id_unit_kerja">
                                                        @foreach ($unitKerja as $item)
                                                            <option value="{{ $item->id_unit_kerja }}"
                                                                @if (old('id_unit_kerja')) selected @endif>
                                                    ...
                                                    <select class="form-select" id="id_agama" name="id_agama">
                                                        @foreach ($agama as $item)
                                                            <option value="{{ $item->id_agama }}"
                                                                @if (old('id_agama')) selected @endif>
                                                                {{ $item->nama_agama }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div
                                                ...
                                                <div class="flex-row-reverse d-flex align-items-center position-relative"
                                                    ...
                                                    <input type="password" class="py-2 mt-1 form-control"
                                                        placeholder="e.g. p455w0rd" id="password" name="password"
                                                        maxlength="255" />
                                        ...
                                        <div class="mb-1 col-md-6 col-12">
                                            <div
                                                ...
                                                <div class="flex-row-reverse d-flex align-items-center position-relative"
                                                    id="wrapper">
                                                    <input type="password" class="py-2 mt-1 form-control"
                                                        placeholder="e.g. p455w0rd" id="password-confirmation"
                                        ...
                                        <div class="mb-1 col-12">
                                            <div class="form-group">
                                                <div class="position-relative">
                                                    ...
                                                    <input type="file" id="foto_profil" class="image-crop-filepond"
                                                        name="foto_profil" />
