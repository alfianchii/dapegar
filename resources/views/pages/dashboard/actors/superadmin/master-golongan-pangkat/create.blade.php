        ...
        <div class="page-title">
            <div class="row">
                <div class="order-last col-12 col-md-6 order-md-1">
                    <h2>Buat Golongan Pangkat</h2>
                    <p class="text-subtitle text-muted">
                        Buat sebuah data master golongan pangkat.
                    </p>
                    <hr>
                    <div class="mb-4">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ $dashboardURL }}/master-golongan-pangkat" method="POST">
                                    @csrf
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input autofocus type="text" class="py-2 form-control"
                                                        ...
                                                        value="{{ old('kode_golongan') }}" maxlength="5" />
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input autofocus type="text" class="py-2 form-control"
                                                        ...
                                                        value="{{ old('kode_ruang') }}" maxlength="20" />
                                                    <div class="form-control-icon">
                                                        <i class="py-2 bi bi-card-heading"></i>
                                                    </div>
                                                    @error('kode_ruang')
                                            ...
                                            <div
                                                ...
                                                <div class="position-relative">
                                                    <input autofocus type="text" class="py-2 form-control"
                                                        ...
                                                        name="nama_pangkat" value="{{ old('nama_pangkat') }}"
                                                        maxlength="100" />
                                                    <div class="form-control-icon">
                                                        <i class="py-2 bi bi-card-heading"></i>
                                                    </div>
